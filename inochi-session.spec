...
Source21:       https://github.com/BradleyChatha/lumars/archive/refs/tags/v%{lumars_ver}/lumars-%{lumars_ver}.tar.gz
Source22:       https://github.com/etcimon/memutils/archive/refs/tags/v%{memutils_ver}/memutils-%{memutils_ver}.tar.gz
Source23:       https://github.com/libmir/mir-algorithm/archive/refs/tags/v%{mir_algorithm_ver}/mir-algorithm-%{mir_algorithm_ver}.tar.gz
Source24:       https://github.com/libmir/mir-core/archive/refs/tags/v%{mir_core_ver}/mir-core-%{mir_core_ver}.tar.gz
Source25:       https://github.com/libmir/mir-linux-kernel/archive/refs/tags/v%{mir_linux_kernel_ver}/mir-linux-kernel-%{mir_linux_kernel_ver}.tar.gz
Source26:       https://github.com/D-Programming-Deimos/openssl/archive/refs/tags/v%{openssl_ver}/openssl-%{openssl_ver}.tar.gz
Source27:       https://github.com/dcarp/semver/archive/refs/tags/v%{semver_ver}/semver-%{semver_ver}.tar.gz
Source28:       https://gitlab.com/AntonMeep/silly/-/archive/v%{silly_ver}/silly-v%{silly_ver}.tar.gz
Source29:       https://github.com/wilzbach/stdx-allocator/archive/refs/tags/v%{stdx_allocator_ver}/stdx-allocator-%{stdx_allocator_ver}.tar.gz
Source30:       https://github.com/s-ludwig/taggedalgebraic/archive/refs/tags/v%{taggedalgebraic_ver}/taggedalgebraic-%{taggedalgebraic_ver}.tar.gz
...
Source32:       https://github.com/vibe-d/vibe-core/archive/refs/tags/v%{vibe_core_ver}/vibe-core-%{vibe_core_ver}.tar.gz
Source33:       https://github.com/vibe-d/vibe.d/archive/refs/tags/v%{vibe_d_ver}/vibe-d-%{vibe_d_ver}.tar.gz

# cimgui
Source34:       https://github.com/Inochi2D/cimgui/archive/%{cimgui_commit}/cimgui-%{cimgui_short}.tar.gz
Source35:       https://github.com/Inochi2D/imgui/archive/%{imgui_commit}/imgui-%{imgui_short}.tar.gz
...
install -p -m 644 %{SOURCE36} $RPM_BUILD_ROOT/%{_datadir}/icons/hicolor/256x256/apps/inochi-session.png
